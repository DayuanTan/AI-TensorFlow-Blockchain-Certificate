...
- [Artificial Intelligence on Microsoft Azure](#artificial-intelligence-on-microsoft-azure)
  ...
  - [Part 1 Course](#part-1-course)
    - [1.1. Introduction to the AI Fundamentals program](#11-introduction-to-the-ai-fundamentals-program)
    - [1.2. Introduction to Artificial Intelligence on Azure course](#12-introduction-to-artificial-intelligence-on-azure-course)
    - [1.3. Careers in AI](#13-careers-in-ai)
    - [1.4. The AI-900 Certification](#14-the-ai-900-certification)
    - [1.5. Read: Exam AI-900: Skills Measured](#15-read-exam-ai-900-skills-measured)
    - [1.6. Microsoft expert interview](#16-microsoft-expert-interview)
  ...
  - [Part 2 AI](#part-2-ai)
    ...
    - [2.2. The features of machine learning](#22-the-features-of-machine-learning)
    - [2.3. Anomaly Detection](#23-anomaly-detection)
    - [2.4. Computer Vision](#24-computer-vision)
    - [2.5. NLP](#25-nlp)
    - [2.6. Convenrsational AI](#26-convenrsational-ai)
    - [Take a deeper Dive!](#take-a-deeper-dive)
  - [Part 3: Guiding Principles for Responsible AI](#part-3-guiding-principles-for-responsible-ai)
    - [3.1 Responsible AI](#31-responsible-ai)
    - [Test](#test)
...
## Part 1 Course
### 1.1. Introduction to the AI Fundamentals program
### 1.2. Introduction to Artificial Intelligence on Azure course
...
### 1.4. The AI-900 Certification

40 -  60 questions

question types, including scenarios, Short answers, Multiple choice, Mark Review, and Dragon Drop.

### [1.5. Read: Exam AI-900: Skills Measured](5.Read_Exam_AI-900_Skills_Measured.md)


### 1.6. Microsoft expert interview
...
### 2.2. The features of machine learning
...
Examples:
- to monitor credit card transactions and detect unusual usage patterns that might indicate fraud. 
- an application that tracks activity in an automated production line and identifies failures. 
- a racing car telemetry system that uses sensors to proactively worn engineers about potential mechanical failures before they happen.
...
- Object detection
  - identify the location of different classes of vehicles
- Semantic Segmentation
  - Classify individual pixels in an image
- Image analysis
  - Combine machine learning models with advanced image analysis techniques
- Face detection
  - Analysis
  - Recognition 
- OCR Optical Character Recognition
  - Used to detect and read text in images
- Form processing
  - Read and save information from standard documents (e.g. PDF)


Services
- Azure Computer Vision Service 
- - to analyze images in video and extract descriptions, tags, objects and text. 
- Custom Vision Service 
- - to train custom image classification and object detection models using your own images. 
- Face service
- - to build face detection and facial recognition solutions, you can use the 
- Form recognizer
- - to extract information from scanned forms and invoices.
...
- Speech
- LUIS 
  - language understanding, intelligence service or LUIS to train a language model that can understand spoken or text based command.


### 2.6. Convenrsational AI

Services
- QnA maker
- Azure bot service
  - Developers can use the bot framework to create a bot and manage it with Azure Bot Service, integrating back-end services like QnA maker and LUIS, and connecting to channels for web trash, email, Microsoft Teams, and others.



### Take a deeper Dive!

Use this opportunity to explore further examples and demos in the links provided below. 


- The Yield: How to feed the world without ‘wrecking the planet’ | Transform (microsoft.com)
- The Yield Video: https://www.microsoft.com/enus/videoplayer/embed/RE4voJG  
- Anomaly Detector | Microsoft Azure
- Seeing AI App from Microsoft
- AI Demos (microsoft.com)
- NLP and Starship Commander Video: https://www.microsoft.com/en-us/videoplayer/embed/RE4vyDj
- LUIS (Language Understanding) - Cognitive Services – Microsoft
- Azure Health Bot Project - AI At Work For Your Patients (microsoft.com)

## Part 3: Guiding Principles for Responsible AI
...
- fairness, 
  - AI systems should treat all people fairly.
    - Microsoft Azure Machine Learning includes the capability to interpret models and quantify the extent to which each feature of the data influences the model's prediction. This capability helps data scientists and developers identify and mitigate bias in the model. 
- reliability and safety, 
  - AI systems should perform reliably and safely
    - autonomous vehicle
    - diagnoses patients symptoms and recommends prescriptions
- privacy and security, 
  -  AI systems should be secure and respect privacy
     -  rely on large volumes of data,
- inclusiveness, 
